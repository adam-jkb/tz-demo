...
if((${BUILD_CONTEXT} MATCHES .*Secure.*) OR (NOT DEFINED BUILD_CONTEXT))
    ...
    ExternalProject_Add(vscode_tz_S
	...
	set(ST_TRUST_ZONE_SECURE_PROJECT_BUILD_TARGET ${CMAKE_SOURCE_DIR}/Secure/build/vscode_tz_S${CMAKE_EXECUTABLE_SUFFIX_CXX} CACHE FILEPATH "Path to secure project target")
endif()
#-----------------------Build NonSecure Project-----------------------#
if((${BUILD_CONTEXT} MATCHES .*NonSecure.*) OR (NOT DEFINED BUILD_CONTEXT))
    message("   Build context: " NonSecure)
    ExternalProject_Add(vscode_tz_NS
	...
	set(ST_TRUST_ZONE_NONSECURE_PROJECT_BUILD_TARGET ${CMAKE_SOURCE_DIR}/NonSecure/build/vscode_tz_NS${CMAKE_EXECUTABLE_SUFFIX_CXX} CACHE FILEPATH "Path to nonsecure project target")
endif()
